...
include('newindex2.php'); 
 ...
 $query = "SELECT * FROM g_hotels ORDER BY h_price desc";  
 $result = mysqli_query($connect, $query);  
 ?>  
 <!DOCTYPE html>  
 <html>  
      <head>  
           <title>Hotels in Goa</title>  
	...
	console.log(xhr.readyState);
        ...
        var ttl = 2;
            ...
            getRssFeed =  function()
            {
                ...
                this.xml.open("GET", "goa.php", true);
...
<br>
<div class="c"><p>
<b>Goa is a land that redefines holidays, with its exquisite mix of sun, surf, and beaches; Goa has become the ultimate tourist destination. Goa is a tiny emeralds land with its natural scenic beauty, attractive beaches and temples, famous for its architecture, feast and festivals and hospitable people with a rich culture. So get swept away in Goa by the spectacular sunrises and sunsets and rejuvenate yourself.Goa is India's smallest state in terms of area and the fourth smallest in terms of population.Goa which is  Located on the west coast of India in the region known as the Konkan, it is bounded by the state of Maharashtra to the north, and by Karnataka to the east and south, while the Arabian Sea forms Goas western coast.
			...
			<div class="container" style="width:800px;"> 
                ...
                <div class="col-md-4">  
                     <div style="border:3px solid #ccc; padding:12px; margin-bottom:16px; height:375px;width:250px;" align="center">  
						  ...
						  <?php
						if(($row["h_name"])=="Hotel Crasin"){?>
							<a href="1_1.php">Ratings and Reviews</a><?php } 
						else if(($row["h_name"])=="Hotel Old Goa"){?>
							<a href="1_2.php">Ratings and Reviews</a>
						<?php }
						else if(($row["h_name"])=="Hotel Kimsel"){?>
...
<div class="header">
  <button type="button"><a href="http://localhost/tms/package-details.php?pkgid=12<?php echo htmlentities($result->PackageId);?>">Book Now</a></button>
