	...
	console.log(xhr.readyState);
        ...
        var ttl = 2;
            ...
            getRssFeed =  function()
            {
                ...
                this.xml.open("GET", "Manali.php", true);
...
<div class="header">
  <button type="button"><a href="http://localhost/tms/package-details.php?pkgid=7<?php echo htmlentities($result->PackageId);?>">Book Now</a></button>
